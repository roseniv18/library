export class Library {
    ...
    addBook(newBook, inputs, bookEl) {
        ...
        if (!this.bookExists(newBook)) {
            ...
            (_a = document.querySelector(".no-books")) === null || _a === void 0 ? void 0 : _a.classList.add("hide");
        }
        else {
    ...
    generateCard(newBook, inputs, booksEl) {
        ...
        readBtn.innerHTML = `<i class="fas fa-solid fa-book"></i><span>${hasReadInput.checked ? "Not read" : "Read"}</span>`;
